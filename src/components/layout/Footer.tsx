      ...
      <div className="max-w-[1200px] mx-auto px-4 text-center">
          ...
          <ul className="flex flex-wrap justify-center gap-x-8 gap-y-2">
            {FOOTER.links.explore.map((link) => (
              <li key={link.label}>
                <a
                  href={link.href}
                  className="text-granny hover:text-casablanca transition-colors text-base"
                >
                  {link.label}
                </a>
              </li>
        ...
        <div className="border-t border-white/10 py-4 text-sm text-white/80">
          ...
          <a
            ...
            className="text-casablanca font-semibold hover:text-white transition-colors"
          >
            {FOOTER.email}
          </a>
        </div>
          ...
          <div className="flex items-center gap-4">
            {FOOTER.social.map((item) => (
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 text-white hover:bg-casablanca hover:text-firefly hover:-translate-y-0.5 transition-all duration-300"
              >
